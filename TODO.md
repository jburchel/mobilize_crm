...
[X] Determine what data everyone should see and what data only the individual user should see.- People (not churches)- Tasks - Communications shold all be user specific.

[X] Implement the above (certain data seen by all in an office and certain data seen only by the individual user)
...
[] Implement an easy way to backup the database
[] 